...
|---|---:|
| Build Time | 2.8346s |
| Build Throughput | 35278.40 vectors/sec |
| C++ Build Total | 20.627904s |
| C++ Build Construction | 20.572477s |
| C++ Build Search | 12.540073s |
| C++ Greedy Search | 0.586562s |
| C++ Candidate Search | 11.953511s |
| C++ Build Prune | 4.461064s |
| C++ CSR Export | 0.055414s |
...
| Segment Count | 8 |
| Build Threads | 8 |
| Max Segment Build | 2.742185s |
| Sum Segment Build | 21.070253s |
| QPS | 935.18 |
| Batch Search API | True |
| Native Segmented Batch | True |
| Average Latency | 1.0673 ms |
| p50 Latency | 1.0266 ms |
| p95 Latency | 1.5620 ms |
| p99 Latency | 1.7509 ms |
| Recall@10 | 0.9940 |
