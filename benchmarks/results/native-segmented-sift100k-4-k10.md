...
|---|---:|
| Build Time | 6.1811s |
| Build Throughput | 16178.30 vectors/sec |
| C++ Build Total | 23.589922s |
| C++ Build Construction | 23.536312s |
| C++ Build Search | 15.751794s |
| C++ Greedy Search | 0.712429s |
| C++ Candidate Search | 15.039365s |
| C++ Build Prune | 4.139498s |
| C++ CSR Export | 0.053603s |
...
| Segment Count | 4 |
| Build Threads | 4 |
| Max Segment Build | 6.091485s |
| Sum Segment Build | 23.828340s |
| QPS | 1597.28 |
| Batch Search API | True |
| Native Segmented Batch | True |
| Average Latency | 0.5328 ms |
| p50 Latency | 0.5098 ms |
| p95 Latency | 0.7960 ms |
| p99 Latency | 0.9630 ms |
| Recall@10 | 0.9980 |
